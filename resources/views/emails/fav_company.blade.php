                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                                <tr>
                                    <td class="subtitle"
                                        ...
                                        <p>We are pleased to inform you that you have added "{{ $company_name }}" to your favorite companies.</p>

                                        <p>You can view the details of the company and manage your favorite companies using the link below:</p>
