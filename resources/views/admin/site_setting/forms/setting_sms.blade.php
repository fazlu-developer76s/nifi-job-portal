                        ...
                        <tr>
                            ...
                            <td class="action-btns">
                                ...
                                <button type="button" class="btn btn-primary mt-5" data-toggle="modal"
                                    data-target="#exampleModal" onclick="OpenModal('{{ $tmp->id }}');">
                                    Test Key
                                </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-lsabel="Close"><span
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary"
                                onclick="submitFormTestKey();">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
