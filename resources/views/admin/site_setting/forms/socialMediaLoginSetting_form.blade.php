...
<div class="form-body">        
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'facebook_app_id') !!}">
        ...
        {!! Form::text('facebook_app_id', null, array('class'=>'form-control', 'id'=>'facebook_app_id', 'placeholder'=>'Facebook App ID','readonly' => !empty('facebook_api_id') ? 'readonly' : null)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'facebeek_app_secret') !!}">
        ...
        {!! Form::text('facebeek_app_secret', null, array('class'=>'form-control', 'id'=>'facebeek_app_secret', 'placeholder'=>'Facebeek App Secret','readonly' => !empty('facebook_app_secret') ? 'readonly' : null)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'twitter_app_id') !!}">
        ...
        {!! Form::text('twitter_app_id', null, array('class'=>'form-control', 'id'=>'twitter_app_id', 'placeholder'=>'Twitter App ID','readonly' => !empty('twitter_app_id') ? 'readonly' : null)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'twitter_app_secret') !!}">
        ...
        {!! Form::text('twitter_app_secret', null, array('class'=>'form-control', 'id'=>'twitter_app_secret', 'placeholder'=>'Twitter App Secret','readonly' => !empty('twitter_app_secret') ? 'readonly' : null)) !!}
