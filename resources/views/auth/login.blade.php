                ...
                <div class="useraccountwrap">
                    ...
                    <div class="userbtns">
                        <ul class="nav nav-tabs">
                            ...
                            ?>
                            <li class="nav-item">
                                <a class="nav-link {{($c_or_e == 'candidate')? 'active':''}}" data-bs-toggle="tab" href="#candidate" aria-expanded="true">{{__('Candidate')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{($c_or_e == 'employer')? 'active':''}}" data-bs-toggle="tab" href="#employer" aria-expanded="false">{{__('Employer')}}</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="candidate" class="formpanel mt-0 tab-pane {{($c_or_e == 'candidate')? 'active':''}}">
                                <div class="socialLogin">
                                    ...
                                    <a href="{{ url('login/jobseeker/twitter')}}" class="tw"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                                </div>
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="formpanel">
                                        ...
                                        <div class="mb-3">
                                            <i class="fas fa-lock" aria-hidden="true"></i> {{__('Forgot Your Password')}}? 
                                ...
                                <!-- Sign up link -->
                                <div class="newuser">
                                    <i class="fa fa-user" aria-hidden="true"></i> {{__('New User')}}? 
                            ...
                            <div id="employer" class="formpanel mt-0 tab-pane fade {{($c_or_e == 'employer')? 'active':''}}">
                                ...
                                <!-- Sign up link -->
                                <div class="newuser">
                                    <i class="fas fa-user" aria-hidden="true"></i> {{__('New User')}}? 
                                    <a href="{{route('register')}}">{{__('Register Here')}}</a>
                                </div>
                            </div>
                            <!-- End Employer Tab -->
