...
@include('includes.inner_page_title', ['page_title'=>__('Recommended Seekers')]) 
            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    ...
                    <ul class="searchList">
                        ...
                        @else
                            <div class="nodatabox">
                                <h4>{{__('No Recommended Seekers Found.')}}</h4>
                                <div class="viewallbtn mt-2"><a href="{{url('/job-seekers')}}">{{__('Search Seekers')}}</a></div>
                            </div>
                        @endif
                    </ul>
                </div>
